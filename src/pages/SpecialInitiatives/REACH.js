    ...
    return <BaseLayout>
        ...
        <div className="container">
            ...
            <div className="our-value-system mt-5">
                <div className="row">
                    <div className="col-md-12  ">
                        <h2 className="values-system-heading">Objectives </h2>
                        <li className="values-system-para mt-2 pe-3">
                            To establish a dedicated redress and response system for complaints related to and by Children, against maladministration by any Provincial agency;    </li>
                        <li className="values-system-para mt-2 pe-3">
                            To provide a platform for addressing Child Rights issues through research, advocacy and engagement with Children and other stakeholders on Children’s Rights;                        </li>
                        <li className="values-system-para mt-2 pe-3">
                            To enable the Provincial Mohtasib (Ombudsman) to advise the Government on systemic issues that impacts the Rights of Children and compliance with the UNCRC.                        </li>
                    </div>
                </div>
            </div>
        </div>
